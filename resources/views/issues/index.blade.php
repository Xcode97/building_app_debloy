...
<div class="container">
    ...
    <form methood="post" action="issues/store">
        @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" required value="{{ Auth::user()->name}}" >
  </div>
  <div class="mb-3">
